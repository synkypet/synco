...
import { AlertCircle, Loader2, KeyRound, CheckCircle2, Mail, ArrowLeft } from 'lucide-react';
    ...
    return (
      <TactileCard className="w-full max-w-md p-10 relative border-none shadow-skeuo-elevated group mx-auto animate-in fade-in zoom-in duration-500">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-black font-headline text-white mb-4 uppercase tracking-tighter italic">Link Enviado</h2>
          <p className="text-sm text-white/40 leading-relaxed mb-10">
            Enviamos um link de recuperação para <span className="text-white font-bold">{email}</span>. Verifique sua caixa de entrada.
          </p>
    ...
    <TactileCard className="w-full max-w-md p-6 md:p-10 relative border-none shadow-skeuo-elevated group mx-auto">
      ...
      <div className="flex flex-col items-center mb-8">
        <div className="w-16 h-16 rounded-2xl bg-deep-void shadow-skeuo-pressed flex items-center justify-center mb-6 relative group/icon overflow-hidden">
          ...
          <KeyRound className="w-8 h-8 text-kinetic-orange shadow-glow-orange-intense relative z-10" />
        </div>
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20">
          Solicitar nova chave de comando
        </p>
      </div>
      ...
      <form onSubmit={handleResetPassword} className="space-y-6">
        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="text-center">
            <Link href="/login" className="inline-flex items-center text-[11px] font-bold uppercase tracking-tight text-white/20 hover:text-kinetic-orange transition-colors italic">
      ...
      <div className="mt-10 text-center opacity-10 flex flex-col items-center gap-1 group-hover:opacity-30 transition-opacity duration-700">
        ...
        <p className="text-[8px] font-black uppercase tracking-[0.4em]">Passkey Reset Pipeline</p>
